...
void FillMatrix(int[,,] matrix, int i, int j, int k, int min, int max )
{
 ...
 for (int n = 0; n <=  i; n++)
                {
                    for (int m = 0; m <= j; m++)
                    {
                        for (int b = 0; b < k; b++)
                        {
                            if (matrix[n, m, b] == matrix[i, j, k])
                            {

                                
                                    
                                    
                                        FillMatrix(matrix, i,  j,  k,  min, max);
...
//                         {
//                             if (matrix3d[n, m, l] == matrix3d[i, j, k])
//                             {
...
//                                     } while (matrix3d[i, j, k] == matrix3d[n, m, l]);
...
// }
    ...
    int[,,] matrix3D = CreateMatrix3D(2, 2, 2, 10, 20);
